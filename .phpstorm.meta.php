...
'filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'session.secure','session.http_only','session.same_site','session.partitioned','livewire.class_namespace',
...
'livewire.inject_morph_markers','livewire.pagination_theme','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'livewire.update','livewire.upload-file','livewire.preview-file','dashboard','admin.dashboard',
'admin.families.index','admin.families.create','admin.families.store','admin.families.show','admin.families.edit',
'admin.families.update','admin.families.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.families.index','api.api-token-manager','api.index','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.two-factor-challenge',
...
'components.dropdown-link','components.form-section','components.input','components.input-error','components.label',
'components.modal','components.nav-link','components.responsive-nav-link','components.secondary-button','components.section-border',
'components.section-title','components.switchable-team','components.validation-errors','components.welcome','dashboard',
'emails.team-invitation','layouts.admin','layouts.app','layouts.guest','layouts.partials.admin.breadcrumb',
'layouts.partials.admin.navigation','layouts.partials.admin.sidebar','navigation-menu','policy','profile.delete-user-form',
...
'terms','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'laravel-exceptions-renderer::components.laravel-ascii-spotlight','laravel-exceptions-renderer::components.layout','laravel-exceptions-renderer::components.overview','laravel-exceptions-renderer::components.query','laravel-exceptions-renderer::components.request-body',
...
'actions.update','actions.user','actions.view','actions.yes','http-statuses.0',
...
'http-statuses.599','http-statuses.unknownError','validation.attributes.address','validation.attributes.affiliate_url','validation.attributes.age',
...
'validation.attributes.work','validation.attributes.year',);
